...
class ExportService : Service() {
    ...
    companion object {
        ...
        const val ACTION_START_EXPORT = "com.apexfield.engine.action.START_EXPORT"
        const val ACTION_CANCEL_EXPORT = "com.apexfield.engine.action.CANCEL_EXPORT"
    ...
    private fun buildProgressNotification(progress: Int, statusText: String): Notification {
        return NotificationCompat.Builder(this, CHANNEL_ID)
            .setContentTitle("APEX FIELD: Exporting Photo")
